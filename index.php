      ...
      <rs-slides>
        <rs-slide
          ...
          <!--
            ...
            style="z-index: 9; background-color: #fd4a18">Read More
          </a>
          <!--
          ...
          <rs-layer
            ...
            data-frame_1="st:700;sp:1000;"
            data-frame_999="o:0;st:w;"
            style="z-index: 11">It is a long established fact that a reader will be distracted
            by<br />
          ...
          <!--
            ...
            style="z-index: 8; background-color: #ffffff">Contact Us
          </a>
          <!--
          ...
          <div
            ...
            <div class="item">
              <div class="pq-portfolio-block">
                ...
                <div class="pq-portfolio-info">
                  ...
                  <h5>
                    <a href="portfolio-single.html">Professional Services</a>
                  </h5>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="pq-portfolio-block">
                ...
                <div class="pq-portfolio-info">
                  <div class="pq-portfolio-link">
                    <a href="portfolio-single.html">Design</a><a href="portfolio-single.html">Technology</a>
                  </div>
                  <h5>
      ...
      <div class="col-xl-6 col-lg-6">
        ...
        <ul class="pq-list-check">
          ...
          <li class="pq-list-item">
            <a href="#">
              <i class="ion ion-android-done-all"></i>
              <span>Vestibulum blandit justo at felis dapibus varius
                more-or-less.</span>
            </a>
          </li>
          <li class="pq-list-item">
            <a href="#">
              <i class="ion ion-android-done-all"></i>
              <span>Nunc ut risus suscipit, egestas diam in, consequat odio use
                Lorem Ipsum.</span>
            </a>
          </li>
          <li class="pq-list-item">
            <a href="#">
              <i class="ion ion-android-done-all"></i>
              <span>Proin sed nunc consectetur, convallis risus nec, efficitur
                felis.</span>
            </a>
          </li>
          <li class="pq-list-item">
          ...
          <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
            <a
              ...
              <div class="pq-tabs-icon">
                <i class="flaticon-marketing"></i><span>Mobile Development</span>
              </div>
            </a>
            <a
              ...
              aria-selected="true">
              <div class="pq-tabs-icon">
                <i class="flaticon-call-center"></i><span>Software Development</span>
              </div>
            </a>
            <a
              class="pq-tabs nav-item nav-link"
              ...
              aria-selected="true">
              <div class="pq-tabs-icon">
                <i class="flaticon-data-analytics"></i><span>QA Testing</span>
              </div>
            </a>
            <a
              class="pq-tabs nav-item nav-link"
              ...
              aria-selected="true">
              <div class="pq-tabs-icon">
                <i class="flaticon-ux-design"></i><span>Product design</span>
              </div>
            </a>
          </div>
  ...
  <div class="container">
    <div class="row pq-bg-primary align-items-center">
      <div
        ...
        <a
          href="contact-us.html"
          class="pq-button pq-btn-flat pq-mt-30 pq-button-dark">
          <div class="pq-button-block">
          ...
          <div class="row g-0">
            <div class="col-lg-4 p-0">
              <div class="pq-footer-items">
                ...
                <div class="pq-footer-items-info">
                  <h4>Address</h4>
                  <span>
                    Lastcode AI Technology Pvt. Ltd., BY Campus, Near
                    Eklingpura Choraha, Udaipur, Rajasthan
                  </span>
                </div>
              </div>
            </div>
            <div class="col-lg-4 p-0">
              <div class="pq-footer-items">
                ...
                <div class="pq-footer-items-info">
                  <h4>call Us On</h4>
                  <a href="tel:+91 759713202047824">
                    <span>+91 7597132020</span>
                  </a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 p-0">
              <div class="pq-footer-items border-0">
                ...
                <div class="pq-footer-items-info">
                  <h4>Email Us</h4>
                  <a href="mailto:contact@lastcode.ai"><span>contact@lastcode.ai</span></a>
                </div>
              </div>
            </div>
          </div>
